...
async def on_afk(event):
    ...
    if USER_AFK and not (await event.get_sender()).bot:  # pylint:disable=E0602
        ...
        message_to_reply = f"**My Master is offline** ! \n\n**Reason** : `{reason}` \n\n**Afk Since** : {afk_since}" + \
            f"\n\n__Kindly Leave A Message__ ! \n`Master Will Reply To You Soon !`" \
            if reason \
            else f"**Hello, Master Is offline Right Now And May Be Forgot List Reason ! Any Way He Will Come Back Soon !**"
