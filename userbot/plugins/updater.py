...
OFFICIAL_UPSTREAM_REPO = "https://github.com/TeamAtul/EdithUserbot"
BOT_IS_UP_TO_DATE = "Edith userbot is up-to-date!"
NEW_BOT_UP_DATE_FOUND = (
    "**Edith Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
